...
> 성공 신호 — "`v20.x.x` 같은 버전 번호가 나오면 OK."
> 실패 대응 — "`command not found` 가 나오면 미설치. https://nodejs.org 에서 LTS 버전 설치 안내."
...
> 사용자에게 설명 — "CLI는 터미널에서 AI를 부르는 명령어입니다. VS Code 확장과 별개로 CLI도 있으면 편해요."
...
> 설치에 2~3분 걸릴 수 있다고 미리 안내해줘. 진행 중 다른 창을 닫지 말라고 말해줘.
